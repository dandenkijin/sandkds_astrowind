<script>
  ...
  // Configuration
  const FORM_URL = 'https://forms.zohopublic.com/sandkds1/form/SnugsandKissesDoulaIntake/formperma/iQK25B2BCzJQXKelEBa_HY8LWOuI0xofBYm63y4UMbo?zf_enablecamera=true';
  const FORM_TITLE = 'Snugs and Kisses Doula Intake';
